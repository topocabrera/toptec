...
export default class AddTurno extends Component {
  constructor(props) {
    super(props);
    ...
    this.onChangeCancha = this.onChangeCancha.bind(this);
    ...
    return (
      <Container component="main" maxWidth="xs">
        {this.state.submitted ? (
          <div>
            <h4>Turno creado correctamente!</h4>
            <a
              role="button"
            ...
            <div className="login-container">
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  ...
                  <Select
                    onChange={this.onChangeCancha}
                    value={this.state.cancha}
                    className="select__form"
                    fullWidth
                  >
                    {canchas.map((cancha) => (
                      <MenuItem key={cancha.value} value={cancha.value}>
                        {cancha.name}
                      </MenuItem>
                    ))}
                  </Select>
